name = "Minimap HUD Server Version"
description = "Adds a minimap to the HUD. Automatically installs on clients so they don't have to go and download it themselves. All credits to original author squeek."
author = "squeek"
version = "1.0.7"
