...
local function onattack(inst, owner, target)
    if math.random() < TUNING.RuinsBatSummonChance then
...
local function fn(Sim)
    ...
    inst.components.weapon:SetDamage(TUNING.RuinsBatDamage)
    inst.components.weapon:SetOnAttack(onattack)
    
    -------
    
    inst:AddComponent("finiteuses")
    inst.components.finiteuses:SetMaxUses(TUNING.RuinsBatUses)
    inst.components.finiteuses:SetUses(TUNING.RuinsBatUses)
