...
local function fn(Sim)
    ...
    inst.components.health:SetMaxHealth(TUNING.EndGame_Thulecite_Durability)
    inst.components.health:StartRegen(TUNING.RegenRate, 1)
    
    inst:AddComponent("combat")
    inst.components.combat:SetRange(TUNING.EYETURRET_RANGE)
    inst.components.combat:SetDefaultDamage(TUNING.EyeTurretDamage)
