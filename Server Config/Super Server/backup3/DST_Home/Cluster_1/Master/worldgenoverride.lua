...
return {
	...
	overrides = {
		...
		boons = "rare", 			-- "never", "rare", "default", "often", "always"
		prefabswaps_start = "classic", 			-- "classic", "default", "highly random"
		prefabswaps = "none", 			-- "none", "few", "default", "many", "max"
		...
		-- MONSTERS
		spiders = "often", 			-- "never", "rare", "default", "often", "always"
		...
		chess = "rare", 			-- "never", "rare", "default", "often", "always"
